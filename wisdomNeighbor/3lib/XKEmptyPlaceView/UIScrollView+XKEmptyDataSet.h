...
@protocol XKEmptyDataSetSource;
@protocol XKEmptyDataSetDelegate;

#define XKEmptyDataSetDeprecated(instead) DEPRECATED_MSG_ATTRIBUTE(" Use " # instead " instead")

/**
 A drop-in UITableView/UICollectionView superclass category for showing empty datasets whenever the view has no content to display.
 @discussion It will work automatically, by just conforming to XKEmptyDataSetSource, and returning the data you want to show.
 */
@interface UIScrollView (XKEmptyDataSet)

/** The empty datasets data source. */
@property (nonatomic, weak, nullable) IBOutlet id <XKEmptyDataSetSource> emptyDataSetSource;
/** The empty datasets delegate. */
@property (nonatomic, weak, nullable) IBOutlet id <XKEmptyDataSetDelegate> emptyDataSetDelegate;
...
/**
 ...
 @discussion The data source must adopt the XKEmptyDataSetSource protocol. The data source is not retained. All data source methods are optional.
 */
@protocol XKEmptyDataSetSource <NSObject>
@optional
 ...
 */
- (CGPoint)offsetForEmptyDataSet:(UIScrollView *)scrollView XKEmptyDataSetDeprecated(-verticalOffsetForEmptyDataSet:);
...
/**
 ...
 @discussion The delegate can adopt the XKEmptyDataSetDelegate protocol. The delegate is not retained. All delegate methods are optional.
 ...
 */
- (void)emptyDataSetDidTapView:(UIScrollView *)scrollView XKEmptyDataSetDeprecated(-emptyDataSet:didTapView:);
...
/**
 ...
 @param scrollView A scrollView subclass informing the delegate.
 */
- (void)emptyDataSetDidTapButton:(UIScrollView *)scrollView XKEmptyDataSetDeprecated(-emptyDataSet:didTapButton:);
...
#undef XKEmptyDataSetDeprecated
