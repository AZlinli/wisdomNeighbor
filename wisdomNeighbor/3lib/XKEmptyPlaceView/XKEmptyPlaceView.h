...
/**不带按钮的占位图
 目前需求是网络错误加重试按钮 而不是点击屏幕重试
 所以内部检测到图片是失败图时内部调用了下方带按钮的方法
 会加重试按钮 viewAllowTap会自动设为NO 响应事件在按钮上
 */
...
/**按钮文字颜色 XKMainTypeColor*/
@property(nonatomic, strong) UIColor *btnColor;
/**按钮文字字体 default：14.0*/
@property(nonatomic, strong) UIFont *btnFont;

/**按钮背景请通过设置背景图片方式 图片名称字符串/image/UIColor*/
...
/**verticalOffset  topOffset  topMutiOffset 只能有一个生效 topMutiOffset默认为0.12*/
/**以居中的形式 垂直方向偏移量 */
