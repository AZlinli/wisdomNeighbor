...
@property (nonatomic, strong, readonly) NSRegularExpression *expressionRegularExpression;
@property (nonatomic, strong, readonly) NSDictionary *expressionMap;

+ (instancetype)expressionWithRegex:(NSString*)regex plistName:(NSString*)plistName bundleName:(NSString*)bundleName;
+ (instancetype)expressionWithRegex:(NSString*)regex expressionMap:(NSDictionary*)expressionMap bundleName:(NSString*)bundleName;
