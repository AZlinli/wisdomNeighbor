...
- (void)setTopMargin:(CGFloat)topMargin {
	...
	[_borderLine mas_updateConstraints:^(MASConstraintMaker *make) {
		make.top.equalTo(superView).offset(ws.topMargin);
	}];
}
...
- (void)setLeftMargin:(CGFloat)leftMargin {
    ...
    XKWeakSelf(ws);
	[_borderLine mas_updateConstraints:^(MASConstraintMaker *make) {
		make.left.equalTo(superView).offset(ws.leftMargin);
	}];
}
...
- (void)setBottomMargin:(CGFloat)bottomMargin {
	...
	[_borderLine mas_updateConstraints:^(MASConstraintMaker *make) {
		make.bottom.equalTo(superView).offset(-ws.bottomMargin);
	}];
}
...
- (void)setRightMargin:(CGFloat)rightMargin {
	...
	[_borderLine mas_updateConstraints:^(MASConstraintMaker *make) {
		make.right.equalTo(superView).offset(-ws.rightMargin);
	}];
}
