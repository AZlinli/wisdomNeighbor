...
- (void)cyl_showTabBadgePoint {
    ...
    UITabBar *tabBar = [[self cyl_getViewControllerInsteadOfNavigationController] cyl_tabBarController].tabBar;
    [self.cyl_tabButton cyl_showTabBadgePoint:tabBar];
...
- (void)cyl_removeTabBadgePoint {
    if (self.cyl_isPlusChildViewController) {
     ...
     UITabBar *tabBar = [[self cyl_getViewControllerInsteadOfNavigationController] cyl_tabBarController].tabBar;
   [self.cyl_tabButton cyl_removeTabBadgePoint:tabBar];
//    [tabBar layoutIfNeeded];
}
