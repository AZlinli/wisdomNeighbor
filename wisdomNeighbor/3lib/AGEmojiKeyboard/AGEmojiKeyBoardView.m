  ...
  self = [super initWithFrame:frame];
    ...
    // initialize category
        ...
        self.segmentsBar.frame = CGRectMake(0,
                                        CGRectGetHeight(self.frame) - CGRectGetHeight(self.segmentsBar.bounds),
                                        CGRectGetWidth(self.bounds),
        ...
        [self.segmentsBar setBackgroundColor:[UIColor whiteColor]];
        self.segmentsBar.layer.cornerRadius = 0;
        self.segmentsBar.clipsToBounds = YES;
        self.segmentsBar.tintColor = UIColorFromRGB(0xd3d9e0);
...
- (void)emojiPageView:(AGEmojiPageView *)emojiPageView didUseEmoji:(NSInteger)emotionIndex {
