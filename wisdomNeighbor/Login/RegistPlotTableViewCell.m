...
@implementation RegistPlotTableViewCell
...
- (void)initViews {
    ...
    UITextField *rightLabel = [[UITextField alloc]init];
    rightLabel.textColor = UIColorFromRGB(0x777777);
    rightLabel.font = [UIFont setFontWithFontName:XK_PingFangSC_Regular andSize:14];
