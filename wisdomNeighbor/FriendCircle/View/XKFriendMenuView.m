...
- (void)setup {
    ...
    self.likeButton = [self creatButtonWithTitle:@"赞" image:[UIImage imageNamed:@"AlbumLike"] selImage:[UIImage imageNamed:@"AlbumLike"] target:self selector:@selector(likeButtonClicked)];
    self.commentButton = [self creatButtonWithTitle:@"评论" image:[UIImage imageNamed:@"AlbumComment"] selImage:[UIImage imageNamed:@"AlbumComment"] target:self selector:@selector(commentButtonClicked)];
